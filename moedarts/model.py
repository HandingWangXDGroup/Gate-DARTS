...
class Cell(nn.Module):
  def __init__(self, genotype, C_prev_prev, C_prev, C, reduction, reduction_prev, reweight=False):
...
if __name__ == '__main__':
  import genotypes
  genotype = genotypes.MoEDARTS
  net = NetworkCIFAR(36, 10, 20, True, genotype)
  torch.save(net.state_dict(),"moedarts.t7")
  print(net)
