...
def main():
  ...
  for epoch in range(args.epochs):
    ...
    train_acc, train_obj = train(train_queue, model, None, criterion, model_optimizer, lr, epoch)
...
def train(train_queue, model, architect, criterion, model_optimizer, lr, epoch=None):
